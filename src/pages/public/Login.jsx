...
const Login = () => {
  ...
  const handleLogin = (e) => {
    e.preventDefault();
    // Simulación: Cualquier usuario entra como instructor
        ...
        <div className="login-card">
          ...
          <form onSubmit={handleLogin}>
            ...
            <div className="form-group">
              ...
              {/* --- ESTE ES EL ENLACE QUE ESTABA FALTANDO --- */}
            ...
            <div className="login-footer-text">
              ¿No tienes cuenta? <Link to="/registro">Consulta con tu coordinador</Link>
            </div>
          </form>
