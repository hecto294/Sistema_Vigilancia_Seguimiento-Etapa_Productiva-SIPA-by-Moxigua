...
const Header = ({ user, notifications = [] }) => {
  ...
  // ==========================================================
  // Navega al perfil según el rol - SIN ALERTS
  // ==========================================================
  const handleViewProfile = () => {
    ...
    const userStorage = userStr ? JSON.parse(userStr) : {};
    const roleFromStorage = userStorage.role || userStorage.rol_nombre || '';

    const rawRole = (roleFromUser || roleFromStorage || '').toLowerCase();
    const role = rawRole
      .normalize('NFD')
      .replace(/[\u0300-\u036f]/g, '')
      .trim();
